    ...
    <>
      ...
      <div className="min-h-screen bg-momta-night text-foreground overflow-x-hidden">
        ...
        <main>
          ...
          {/* Navigation to Research & Updates */}
            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                <p className="text-lg text-momta-slate max-w-2xl mx-auto">
                  Discover our latest research breakthroughs and stay updated with our technological innovations
                </p>
                <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="glass" size="lg" asChild className="gap-3">
                      <a href="/research">
                  ...
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button variant="outline" size="lg" asChild className="gap-3">
                      <a href="/updates">
